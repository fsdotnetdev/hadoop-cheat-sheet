...
#### DataNode
เป็นโหนดที่ใช้ทำงานในระบบ HDFS หรือเรียกว่า WorkerNode จะทำการรับคำสั่งจาก NameNode ในการอ่านเขียนหรือจัดเก็บข้อมูล โดยจะทำการแบ่ง File ที่ได้รับออกเป็น Block ซึ่งแต่ละ Block จะถูกเก็บอยู่ใน DataNode
